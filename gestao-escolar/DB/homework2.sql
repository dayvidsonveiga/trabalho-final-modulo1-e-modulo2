...
CREATE TABLE PROFESSOR (
  ...
  CONSTRAINT FK_PROFESSOR.ID_ENDERECO
...
CREATE TABLE DISCIPLINA (
  ...
  CONSTRAINT FK_DISCIPLINA.ID_PROFESSOR
    FOREIGN KEY (ID_PROFESSOR)
      REFERENCES PROFESSOR(ID_PROFESOR)
);
...
CREATE TABLE ALUNO (
  ...
  CONSTRAINT FK_ALUNO.ID_CURSO
    FOREIGN KEY (ID_CURSO)
      REFERENCES CURSO(ID_CURSO),
  CONSTRAINT FK_ALUNO.ID_ENDERECO
    FOREIGN KEY (ID_ENDERECO)
      REFERENCES ENDERECO(ID_ENDERECO)
);
...
CREATE TABLE NOTAS (
  ...
  CONSTRAINT FK_NOTAS.ID_ALUNO
    FOREIGN KEY (ID_ALUNO)
      REFERENCES ALUNO(ID_ALUNO),
  CONSTRAINT FK_NOTAS.ID_DISCIPLINA
...
CREATE TABLE DISCIPLINA_X_CURSO (
  ...
  CONSTRAINT FK_DISCIPLINA_X_CURSO.ID_CURSO
    FOREIGN KEY (ID_CURSO)
      REFERENCES CURSO(ID_CURSO),
  CONSTRAINT FK_DISCIPLINA_X_CURSO.ID_DISCIPLINA
    FOREIGN KEY (ID_DISCIPLINA)
      REFERENCES DISCIPLINA(ID_DISCIPLINA)
);
...
INSERT INTO VEMSER_JEAN.PROFESSOR (ID_PROFESSOR, NOME, TELEFONE, EMAIL, REGISTRO_TRABALHO, CARGO, SALARIO, ID_ENDERECO)
VALUES (SEQ_PROFESSOR.nextval, 'José Antônio', '5511999995555', 'jose.antonio@gmail.com', SEQ_REGISTRO_TRABALHO, 'Professor', 5500, 1);

INSERT INTO VEMSER.JEAN.DISCIPLINA (ID_DISCIPLINA, NOME, ID_PROFESSOR)
VALUES (SEQ_DISCIPLINA.nextval, 'Física', 1);

INSERT INTO VEMSER.JEAN.CURSO (ID_CURSO, NOME)
VALUES (SEQ_CURSO, 'Engenharia Mecânica');

INSERT INTO VEMSER_JEAN.ALUNO (ID_ALUNO, NOME, TELEFONE, EMAIL, MATRICULA, ID_CURSO, ID_ENDERECO)
VALUES (SEQ_ALUNO, 'Fernando Fernandes', '5522888883333', 'fernando.fernandes@gmail.com', SEQ_ALUNO_MATRICULA.nextval, 1, 2);

INSERT INTO VEMSER_JEAN.NOTAS (ID_NOTAS, N1, N2, N3, N4, ID_DISCIPLINA, ID_ALUNO)
VALUES (SEQ_NOTAS, NULL, NULL, NULL, NULL, NULL, 1, 1)

INSERT INTO VEMSER_JEAN.DISCIPLINA_X_CURSO (ID_DISCIPLINA_X_CURSO, ID_DISCIPLINA, ID_CURSO)
VALUES (SEQ_DISCIPLINA_X_CURSO, 1, 1);
